...
![dataset-statistics](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/classification%20datasets.png)
# Running
...
```
# Full results of zero-shot learning
![full results of zero-shot learning](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/full-classification.png)
