...
![dataset-statistics](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/long-few%20datasets.png)
# Running
🚀 We provide the experiment scripts of MSH-LLM on all dataset under the folder `./scripts`. You can obtain the full results by running the following command:
```
# Train on ETTh1
...
![5full results of few-shot learning](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/full-5few.png)
## Few-shot learning results under 10% training data.
![10full results of few-shot learning](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/full-10few.png)
