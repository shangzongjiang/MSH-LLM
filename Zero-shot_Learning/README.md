...
![dataset-statistics](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/shot-zero%20datasets.png)
# Running
...
![full results of zero-shot learning](https://github.com/shangzongjiang/MSH-LLM/blob/main/figures/full-zero.png)
